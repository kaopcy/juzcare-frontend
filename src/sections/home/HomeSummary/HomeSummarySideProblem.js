...
function HomeSummarySideProblem() {
   return (
      <article className="flex aspect-[10/11] w-52 flex-col items-center justify-center rounded-md bg-paper ">
         ...
         <div className="relative  aspect-square w-16 rounded-full bg-text ">
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-[80%] rotate-90 h-[50%] w-2 -translate-x-1/2 bg-white"/>
